...
def crop_image_uniform(template_image, base_output_dir):
    ...
    if (base_output_dir == './cropped_output_kor'):
        ...
        base_list = ["0041", "0042", "0043", "0044", "0045", "0046", "0047", "0048", "0049", "004A", "004B", "004C", "004D",
                     ...
                     "0021", "0022", "0023", "0024", "007B", "007D", "0027", "0028", "0029", "002A", "002B", "002F", "002D",
                     "002E", "002C", "005B", "005D", "0025", "003A", "003B", "003C", "003D", "003E", "003F", "0040", "005E",
                     "0030", "0031", "0032", "0033", "0034", "0035", "0036", "0037", "0038", "0039", "007E", "005C", "005F"
                     ]
    ...
    for j in range(0, rows):
        for i in range(0, cols):
            ...
            if (base_list[j * cols + i]=="002E" or base_list[j*cols+i]=="002C" or base_list[j*cols+i]=="005F") :
                continue
            else:
