...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
            ...
            // URL 별 권환 확인
            .authorizeRequests()
            .antMatchers("/api/v1/member/email/**","/docs/**", "/api/v1/member/signup/**", "/api/v1/member/login/**", "/swagger-ui.html","/api/v1/member/nickname/duplicate/**","/api/v1/font/list/NoAuth/**").permitAll()
