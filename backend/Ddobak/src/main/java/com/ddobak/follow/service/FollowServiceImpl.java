...
public class FollowServiceImpl implements FollowService{
    ...
    @Override
    @Transactional
    public HttpStatus createFollow(Long followerId, Long followingId) {
    ...
    @Override
    @Transactional
    public HttpStatus unfollow(Long followerId, Long followingId) {
        if (followRepository.existsByFollowerIdAndFollowingId(followerId, followingId)){
            followRepository.deleteByFollowerIdAndFollowingId(followerId, followingId);
            return HttpStatus.NO_CONTENT;
        }
        throw new RuntimeException("The user is not following the target user.");
    }
