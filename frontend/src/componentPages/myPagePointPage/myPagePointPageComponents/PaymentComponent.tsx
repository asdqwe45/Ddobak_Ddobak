...
const PaymentComponent: React.FC<PaymentProps> = ({ amount, onPaymentSuccess, onPaymentFailure, onPaymentCancel }) => {
  ...
  return (
    <button onClick={onClickPayment}>결제창</button>
  );
};
